...
let%test_unit "edit.edit_non_root_observe_id_top" =
  ...
  [%test_eq: bool] (Im_main.is_locally_executed (DocumentManager.Internal.execution_state st) s2.id) false;
...
let%test_unit "edit.edit_non_root_observe_id" =
  ...
  [%test_eq: bool] (Im_main.is_locally_executed (DocumentManager.Internal.execution_state st) s3.id) false;
